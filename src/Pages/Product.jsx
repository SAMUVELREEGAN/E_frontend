    ...
    <div>
        <div style={{display:"flex", flexWrap:"wrap"}}>
            ...
            <div style={{display:"flex",flexDirection:"column" , width:"100px",margin:"10px",height:"150px"}} className='product_maping_image'>
                { productData && productData.image.map((item,index)=>(<img key={index} onClick={()=>setImage(item)} src={item} style={{margin:"10px",width:"100%" ,height:"100%"}} alt='error'/>))}
            </div>
            ...
            <div className='ms-3'>
                    ...
                    <div>
                        <button onClick={()=>addToCart(productData._id,size)} style={{marginTop:"40px" , padding:"10px" , backgroundColor:"black",color:"white"}}>ADD TO CART</button>
                    </div>
                    <div>
